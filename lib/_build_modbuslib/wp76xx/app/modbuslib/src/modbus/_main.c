...
// Startup code for the executable 'modbus'.
...
LE_SHARED const char* _modbuslib_modbus_ServiceInstanceName = "modbus";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t modbus_exe_LogSession;
LE_SHARED le_log_Level_t* modbus_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    modbus_exe_LogSession = log_RegComponent("modbus_exe", &modbus_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_modbuslib.so");
